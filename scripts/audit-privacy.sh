...
TOKEN_PATTERNS="(ghp_[a-zA-Z0-9]{20,}|glpat-[a-zA-Z0-9_-]{20,}|sk-ant-[a-zA-Z0-9_-]{20,}|sk-[a-zA-Z0-9_-]{20,}|AIzaSy[a-zA-Z0-9_-]{33}|xoxb-[a-zA-Z0-9-]+|BEGIN[A-Z ]*PRIVATE KEY|[a-zA-Z0-9._%+-]+@(gmail|yahoo|hotmail|corp)\.[a-zA-Z]{2,})"
