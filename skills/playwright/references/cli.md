...
```bash
export KATALYST_HOME="${KATALYST_HOME:-$HOME/.katalyst}"
export PWCLI="$KATALYST_HOME/skills/playwright/scripts/playwright_cli.sh"
"$PWCLI" --help
```

User-scoped skills install under `$KATALYST_HOME/skills` (default: `~/.katalyst/skills`).
